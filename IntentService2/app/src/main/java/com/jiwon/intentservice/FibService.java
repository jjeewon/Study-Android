package com.jiwon.intentservice;
...
/**
 * 피보나치 수열을 계산하는 FiboService
 *
 * onHandleIntent 안은 워커 스레드(메인스레드가 아닌)에서 실행됩니다.!!
 */
public class FibService extends IntentService {
    ...
    // 브로드캐스트 계산 결과를 주고받기 위한 키
    static final String KEY_CALC_RESULT = "KEY_CALC_RESULT";
    // 브로드캐스트 계산에 걸린 시간(초)를 주고받기 위한 키
    static final String KEY_CALC_MELLISECONDS = "KEY_CALC_MILLISECONDS";
    ...
    protected void onHandleIntent(Intent intent){
        if(intent != null){
            ...
            if(ACTION_CALC.equals(action)){
                ...
                resultIntent.putExtra(KEY_CALC_MELLISECONDS,(end-start)/ 1000 / 1000);
