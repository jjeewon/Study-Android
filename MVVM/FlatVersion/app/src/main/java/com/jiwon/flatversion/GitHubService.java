...
// Retrofit으로 깃헙 API를 이용하기 위한 클래스!!
public interface GitHubService {

    /**
     * 깃헙 레조피토리 검색 결과를 가져온다.
    ...
    /**
     * 레포지토리의 상세 내역을 가져온다.
     * https://developers.github.com/v3/repos/#get
    ...
    public static class Owner{
        ...
        public Owner(String received_events_url, String organizations_url, String avatar_url, String gravatar_id, String gists_url, String starred_url, String site_admin, String type, String url,
        String id, String html_url, String following_url, String event_url, String login, String subscriptions_url, String repos_url, String followers_url){
