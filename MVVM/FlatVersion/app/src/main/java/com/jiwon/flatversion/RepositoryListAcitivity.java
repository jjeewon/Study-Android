 ...
 * 레포지토리 목록을 표시는 액티비티
 */
public class RepositoryListAcitivity extends AppCompatActivity implements RepositoryAdapter.OnRepositoryItemClickListener{
    ...
    /**
     * 지난 1주일간 만들어지 라이브러리의 인기수능로 가져온다.
